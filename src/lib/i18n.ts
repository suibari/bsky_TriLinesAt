...
export const translations = {
  en: {
    ...
    "about.developer.body": "TriLinesAt (hereinafter referred to as \"this app\") is developed personally by Suibari as a hobby.",
  ...
  ja: {
    ...
    "about.developer.body": "TriLinesAt（以下、本アプリ）は すいばり 個人が趣味で開発しています。",
